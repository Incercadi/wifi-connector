...
public class Connector {
     ...
     * 密码路径
     */
    public static final String PASSWORD_PATH = "E:\\wlan\\password\\wake.txt";

    /**
     * 配置文件暂时存放路径
     */
    public static final String PROFILE_TEMP_PATH = "E:\\wlan\\profile";

    /**
     * 破解成功wifi存放路径
     */
    public static final String RESULT_PATH = "E:\\wlan\\record.txt";

    /**
     * 日志存放路径
     */
    public static final String LOG_PATH = "E:\\wlan\\log.txt";
